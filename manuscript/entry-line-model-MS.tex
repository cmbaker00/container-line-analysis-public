...
Invasive species pose a multifaceted threat to society, leading to reductions in agricultural productivity, as well as damages to the environment, human health, and the economy \citep{rai2020invasive}. A large amount of effort goes into managing invasive species, in either eradicating them, or suppressing their numbers to reduce damages. The costs associated with managing invasive species provides governments with an incentive to manage biosecurity risks at their borders to prevent new species establishing. 
