...
\if1\blind
{
  \title{\bf GLM for partially pooled categorical predictors with a case study in biosecurity}
  \author{Christopher M. Baker\thanks{
    We would like to thank Tom Waring for their contribution to editing this manuscript.}\hspace{.2cm}\\
    School of Mathematics and Statistics, University of Melbourne, Australia\\
    Centre of Excellence for Biosecurity Risk Analysis, University of Melbourne, Australia\\
...
\if0\blind
{
  ...
  \bigskip
  \begin{center}
    {\LARGE\bf GLM for partially pooled categorical predictors with a case study in biosecurity}
\end{center}
  \medskip
} \fi
