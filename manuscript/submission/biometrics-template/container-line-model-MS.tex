...
\title[GLM for partially pooled categorical predictors]{GLM for partially pooled categorical predictors with a case study in biosecurity}


\author{Christopher M.\ Baker\(^{1,2,3}\)\email{cbaker1@unimelb.edu.au}, 
Howard Bondell\(^{1,2}\)\email{howard.bondell@unimelb.edu.au},
Nathaniel Bloomfield\(^{1,2,3}\)\email{nathaniel.bloomfield@unimelb.edu.au}, 
Elena Tartaglia\(^{4}\)\email{elena.tartaglia@data61.csiro.au}, and 
Andrew P.\ Robinson\(^{1,3}\)$^{1}$\email{apro\at unimelb.edu.au}. \\
\(^1\) School of Mathematics and Statistics, The University of Melbourne \\
\(^2\) Melbourne Centre for Data Science, The University of Melbourne \\
\(^3\) Centre of Excellence for Biosecurity Risk Analysis, The University of Melbourne \\
\(^4\) Data61, Commonwealth Scientific and Industrial Research Organisation.}
